...
let digestWithdrawERC20BytesL1: Uint8Array;
...
if (utilsZK.isETH(senderFromL2) == true) {
  ...
  digestWithdrawERC20BytesL1 = arrayify(digestWithdrawERC20L1);
...
export { digestWithdrawERC20BytesL1, unsignedWithdrawTxL1 };
