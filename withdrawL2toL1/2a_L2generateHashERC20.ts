...
initWithdrawL2.token = ERC20token;
initWithdrawL2.amount = ethers.utils.parseEther(withdrawAmtERC20);
...
const digestBytesERC20 = arrayify(digest);
if (digestBytesERC20.length !== 32) {
  logger.throwArgumentError("bad digest length", "digest", digest);
}

export { digestBytesERC20, unsignedWithdrawTxL2 };
